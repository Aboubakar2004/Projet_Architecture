...
<body>
    ...
    <?php foreach ($users as $user): ?>
        <li><?= $user['name']; ?><button onclick="toggleFormVisibility()">Modifier</button></li>
        <li><?= $user['surname']; ?><button onclick="toggleFormVisibility()">Modifier</button></li>
        <li><?= $user['email']; ?><button onclick="toggleFormVisibility()">Modifier</button></li>
        <li>
