            ...
            <div class="flex justify-center flex-col sm:flex-row  items-center gap-20">
                <div class="flex flex-col gap-2">
                    <div class="flex flex-col gap-2 text-black">
                        ...
                        <input class="rounded-sm py-1 pl-5 pr-16 focus:outline-none" type="text" id="prenom" name="prenom">
                    </div>

                    <div class=" flex flex-col gap-2 text-black">
                        <label class="text-white" for="nom">Nom:</label>
                        <input class="rounded-sm py-1 pl-5 pr-16 focus:outline-none" type="text" id="nom" name="nom">
                    </div>

                    <div class=" flex flex-col gap-2 text-black">
                        <label class="text-white" for="email">Email:</label>
                        <input class="rounded-sm py-1 pl-5 pr-16 focus:outline-none" type="email" id="email" name="email">
                    </div>

                    <div class=" flex flex-col gap-2 text-black">
                        <label class="text-white" for="telephone">Téléphone:</label>
                        <input class="rounded-sm py-1 pl-5 pr-16 focus:outline-none" type="tel" id="telephone" name="telephone">
                    </div>
